...
def generar_pronostico(df_ventas, nombre_usuario="Emprendedor"):
    """
    Toma un DataFrame de ventas, lo pre-procesa en resúmenes mensuales, diarios y de anomalías,
    llama a la IA con los resúmenes, y muestra el gráfico y el análisis estructurado.
    """
    es_locale = {
